			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($categorias as $categoria): ?>
					<tr>
						...
						<td class="actions">
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $categoria['Categoria']['id']), array('escape' => false), __('Tem certeza que quer deletar # %s?', $categoria['Categoria']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
