					...
					<div class="panel-heading">Menu</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
									<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-edit"></span>&nbsp&nbsp;Editar Álbum'), array('action' => 'edit', $categoria['Categoria']['id']), array('escape' => false)); ?> </li>
									<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Deletar Álbum'), array('action' => 'delete', $categoria['Categoria']['id']), array('escape' => false), __('Tem certeza que quer deletar # %s?', $categoria['Categoria']['id'])); ?> </li>
	...
	<div class="col-sm-9">
		<div class="list-group">
			...
			<ul class="list-group-item">
				<img class="img-thumbnail" src="<?php echo $category['Category']['photo']; ?>" width=400 />
				&nbsp;
			</ul>
			<ul class="list-group-item">
			...
			<div class="col-sm-4">
				<div class="panel panel-primary">
			        <div class="panel-heading">
			            <h3 class="panel-title"><?php echo __('Locais'); ?></h3>
			        </div>
			        <div class="panel-body">
