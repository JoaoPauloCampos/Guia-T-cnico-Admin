	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Editar Patrocinador'); ?></h1>
			</div>
		</div>
	</div>
					...
					<div class="panel-heading">Menu</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								...
								<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Deletar'), array('action' => 'delete', $this->Form->value('Patrocinator.id')), array('escape' => false), __('Tem certeza que quer deletar # %s?', $this->Form->value('Gallery.id'))); ?></li>
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('Patrocinator', array('type' => 'file','role' => 'form')); ?>
				...
				<div class="form-group">
					...
					echo $this->data['Patrocinator']['photo']."?".$randomString; ?>" width="100" />
				</div>
				<div class="form-group">
