...
if (!defined('BASE_LINK')) {
	define('BASE_LINK', 'http://fastapps.com.br/admin/app/webroot/uploads');
}
/**
 * Consumo maximo em MB
 */
if (!defined('CONSUMO_MAXIMO')) {
	$MEGAS = 2049;
	define('CONSUMO_MAXIMO', $MEGAS * 1024 * 1024);
}
